...
subword-nmt apply-bpe -c ./baseline/preprocessed_data/bpe_code --vocabulary baseline/prepared_data/dict.en --vocabulary-threshold 1 < ./baseline/preprocessed_data/train.en  > ./baseline/preprocessed_data/train_bpe.en
subword-nmt apply-bpe -c ./baseline/preprocessed_data/bpe_code --vocabulary baseline/prepared_data/dict.en --vocabulary-threshold 1 < ./baseline/preprocessed_data/valid.en  > ./baseline/preprocessed_data/valid_bpe.en
subword-nmt apply-bpe -c ./baseline/preprocessed_data/bpe_code --vocabulary baseline/prepared_data/dict.en --vocabulary-threshold 1 < ./baseline/preprocessed_data/test.en  > ./baseline/preprocessed_data/test_bpe.en
subword-nmt apply-bpe -c ./baseline/preprocessed_data/bpe_code --vocabulary baseline/prepared_data/dict.en --vocabulary-threshold 1 < ./baseline/preprocessed_data/tiny_train.en  > ./baseline/preprocessed_data/tiny_train_bpe.en

subword-nmt apply-bpe -c ./baseline/preprocessed_data/bpe_code --vocabulary baseline/prepared_data/dict.de --vocabulary-threshold 1 < ./baseline/preprocessed_data/train.de  > ./baseline/preprocessed_data/train_bpe.de
subword-nmt apply-bpe -c ./baseline/preprocessed_data/bpe_code --vocabulary baseline/prepared_data/dict.de --vocabulary-threshold 1 < ./baseline/preprocessed_data/valid.de  > ./baseline/preprocessed_data/valid_bpe.de
subword-nmt apply-bpe -c ./baseline/preprocessed_data/bpe_code --vocabulary baseline/prepared_data/dict.de --vocabulary-threshold 1 < ./baseline/preprocessed_data/test.de  > ./baseline/preprocessed_data/test_bpe.de
subword-nmt apply-bpe -c ./baseline/preprocessed_data/bpe_code --vocabulary baseline/prepared_data/dict.de --vocabulary-threshold 1 < ./baseline/preprocessed_data/tiny_train.de  > ./baseline/preprocessed_data/tiny_train_bpe.de
