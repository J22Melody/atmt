...
def get_args():
    ...
    parser.add_argument('--gamma', default=1, type=float, help='hyper-parameter gamma for the diverse beam search')
        ...
        for i in range(batch_size):
            for j in range(args.beam_size):
                ...
                node = BeamSearchNode(searches[i], emb, lstm_out, final_hidden, final_cell,
                                      mask, torch.cat((go_slice[i], next_word)), (log_p - args.gamma * j) / lp(1, args.alpha), 1)
